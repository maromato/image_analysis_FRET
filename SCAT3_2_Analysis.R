...
###### density plot for intensity of F/A valuse (Fig S4F) ######
...
###### formation of summary data for box plot and statistical analysis (Fig S4F) ######
...
###### heatmap formation for entire image data (NOT USED in the Figure) #######
par(mfrow=c(4,5))
#par(mfrow=c(2,5))
#heatmap1
t <- NT_3_1
